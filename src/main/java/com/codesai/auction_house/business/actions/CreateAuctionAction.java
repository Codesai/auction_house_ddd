...
public class CreateAuctionAction {
    ...
    public String execute(CreateAuctionCommand command) {
        var auction = new Auction(item(command.name, command.description), new Bid(command.startingPrice).money, command.conquerPrice, command.expirationDate, command.minimumOverbiddingPrice);
